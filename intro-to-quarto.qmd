...
この授業の課題の作成には、Quarto文書の利用が必須である。 そこで、今後の授業で使えるテンプレートを配布する。 [stat1_template2023.qmd](https://drive.google.com/file/d/11UqTpnFMX4yTypJwtZUSTfIgfDdvvZrX/view?usp=sharing) をダウンロードし、YAML ヘッダやグローバルチャンクオプションをそのまま利用してほしい。
